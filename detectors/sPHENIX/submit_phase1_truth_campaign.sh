...
if [[ $# -lt 2 || $# -gt 5 ]]; then
  ...
  echo "Example: $0 phase1_truth_100k_zero_vtx output/pp_minbias_truthdst_100k_zero_vtx/dst_files.list 100 10 10000"
  exit 1
fi
...
chmod +x "${SCRIPT_DIR}/run_phase1_truth.sh"

echo "Submitting Phase 1 truth QA campaign:"
