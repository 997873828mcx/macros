...
input_file="DST_TRKR_TRACKS_run2pp_ana475_2024p017_v001-00053877-${padded_id}.root"
input_dir="/sphenix/lustre01/sphnxpro/production/run2pp/physics/ana475_2024p017_v001/DST_TRKR_TRACKS/run_00053800_00053900/dst/"
output_base="kshort_${padded_id}"

# Full path to input file
input_dir_test="${input_dir%/}"
full_input_path="${input_dir_test}/${input_file}"
...
# Run the ROOT macro
root.exe -l -b << EOF
.L Fun4All_KShortReco.C
Fun4All_KShortReco(
  0,                         // nEvents=0 means process all events
